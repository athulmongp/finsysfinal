...
class BankAccount(models.Model):
    ...
    holder = models.ForeignKey(BankAccountHolder, on_delete=models.CASCADE,default='')
...
class BankConfiguration(models.Model):
    ...
    holder = models.ForeignKey(BankAccountHolder, related_name='bank_configurations',  on_delete=models.CASCADE, default='')
